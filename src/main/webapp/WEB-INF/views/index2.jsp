...
<html>
	...
	<body>
		...
		<!-- Bottom_bar -->
			<div id="bottom_bar">
    			<ul>
			        <li onclick="location.href='#'"><img src="./images/bar_home.png" alt="기능1">HOME</li>
			        <li onclick="location.href='#'"><img src="./images/bar_food.png" alt="기능2">내주변맛집</li>
			        <li onclick="location.href='#'"><img src="./images/bar_hash.png" alt="기능3">해시태그</li>
			        <li onclick="location.href='#'"><img src="./images/bar_food2.png" alt="기능4">ㅁㄹ</li>
			    </ul>
			</div>
